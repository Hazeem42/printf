 ...
 * @type_arg: type to print
 * @f: function to print
 *
 * Description: struct for pointers storage to a
 * printer functions.
 */
...
int print_upx(va_list argumenst, char *buf, unsigned int ibuf);
...
char *fill_binary_array(char *binary, long int_in, int isneg, int limit);
